...
export function EnrolmentSidebar() {
  return (
    <aside className="xl:sticky xl:top-28">
      <div
        className="overflow-hidden rounded-[20px] border border-[#e5dfd4] bg-[#efe9df] p-5 shadow-sm sm:p-8"
      ...
      >
        ...
        <p className="mt-3 text-sm leading-relaxed text-[var(--text-secondary)] sm:mt-4">
          Complete each section at your own pace. Our admissions team is here to guide you through every step of joining
          the Shomoukh family.
        </p>

        <div className="relative mt-6 aspect-[4/3] overflow-hidden rounded-2xl border border-[#dfd6c8] bg-white shadow-inner">
          <Image
        ...
        <div className="mt-5 rounded-2xl border border-[#e8e2d6] bg-white p-4 shadow-sm sm:mt-6 sm:p-5">
          <p className="text-sm font-semibold text-[var(--navy)]">Need help with the application?</p>
